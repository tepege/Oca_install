...
#1.- Descarga
echo -e "\nDescargando archivo..."
sudo git clone https://github.com/OCA/l10n-spain.git -b 10.0 /opt/odoo/partner-contact
sudo git clone https://github.com/OCA/partner-contact.git -b 10.0 /opt/odoo/l10n-spain
